...
Hull.component('quiz', {
  ...
  getQuestions: function() {
    ...
    return _.map(questions, function(q) {
      index += 1
      return _.extend(q, { pagination: { index: index, total: questions.length } });
    });
  },
  ...
  startTicker: function() {
    ...
    this.timer  = { countdowns: {}, timings: {}, startedAt: new Date() };
  ...
  selectQuestion: function(qRef) {
    ...
    this.getQuestionEl(qRef).removeClass('hidden');
  },
